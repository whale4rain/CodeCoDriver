...
with_results = [False, True, False, True, False, False]
without_results = [True, False, False, True, True, False]
...
def chart_pass_rate():
    ...
    ax.set_ylim(0, 1.15)
    ax.set_title("Memory A/B Pass Rate (6 cases)", fontweight="bold")
...
def chart_per_case():
    ...
    ax.set_title("Per-Case Memory A/B Result", fontweight="bold")
    ax.legend()
    ax.spines[["top", "right"]].set_visible(False)
    fig.tight_layout()
