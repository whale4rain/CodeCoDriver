...
type Evaluation = { cases: { id: string; name: string; title: string; description: string }[]; runs: { id: string; case_id: string; mode: string; status: string; passed: boolean; duration_ms: number; created_at: string; notes?: string }[]; metrics: { total: number; passed: number; pass_rate: number; by_mode: Record<string, { total: number; passed: number }>; by_case: Record<string, Record<string, { total: number; passed: number }>> } }
